...
/// @author Jon Knight
/// @author Abassian
/// @notice Copyright Abassian 2019, released under the MIT license
...
//GENERATED GENESIS BEGIN 
    ...
    { 
     ...
     addToWhitelist(initWhitelist3, initWhitelistMoniker3); 
    } 
 
 
    function isGenesisWhitelisted(address _address) pure private returns (bool) 
    { 
        return (  ( initWhitelist0 == _address ) || ( initWhitelist1 == _address ) || ( initWhitelist2 == _address ) || ( initWhitelist3 == _address ) ); 
    } 
